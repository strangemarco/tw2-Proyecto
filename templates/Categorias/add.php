            ...
            <div>
                ...
                <p>
                    <?= $isEdit
                        ...
                        : __('Completa los datos para registrar una nueva categoría') ?>
                </p>
            </div>
        </div>
        ...
        <div class="categoria-body">
            ...
            <div class="form-group">
                ...
                <?= $this->Form->text('nombre', [
                    ...
                    'id' => 'nombre',
                    'required' => true,
                    'placeholder' => __('Ingrese el nombre de la categoría')
                ]) ?>
            </div>
            ...
            <div class="form-check-custom">
                ...
                <?= $this->Form->label('activo', __('Activo'), ['class' => 'form-check-label']) ?>
            </div>
